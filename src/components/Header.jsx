...
const InstagramGlowingLogo = () => (
  <div className="relative inline-flex items-center justify-center group px-3 py-1.5 rounded-lg" style={{ perspective: '400px' }}>
    <div className="absolute inset-0 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-500 opacity-20 blur-md rounded-lg animate-pulse" style={{ animationDuration: '2s' }} />
    <div 
      className="relative flex items-center gap-1.5 font-black tracking-wide text-transparent bg-clip-text bg-gradient-to-tr from-yellow-500 via-pink-500 to-purple-600 hover:scale-105 transition-transform duration-300"
      style={{
        filter: "drop-shadow(0px 3px 2px rgba(236,72,153,0.3)) drop-shadow(0px 1px 1px rgba(139,92,246,0.3))"
      }}
    >
      <div className="animate-bounce" style={{ animationDuration: '2.5s' }}>
        <svg 
          ...
          stroke="url(#ig-gradient)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" 
        >
          <defs>
      ...
      <span className="uppercase text-[13px] translate-y-[-1px]">Feeds</span>
    </div>
  </div>
);
