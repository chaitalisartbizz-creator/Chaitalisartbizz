...
function buildWhatsAppMessage(orderId, customerInfo, cartItems, total, paymentMethod) {
  ...
  if (paymentMethod === 'UPI / QR Payment') {
                ...
                {!user && (
                  <div className="mb-2">
                    <button 
                      ...
                      className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 text-gray-700 font-bold py-2.5 rounded-xl hover:bg-gray-50 transition"
                    >
                      ...
                      Sign in with Google to save Order History
                    </button>
                    <div className="flex items-center gap-3 mt-4 text-[10px] font-bold text-stone-400 tracking-wider">
