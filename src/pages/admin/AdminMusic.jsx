    ...
    <div className="max-w-3xl animate-fade-in">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-black text-gray-800 tracking-tight mb-2 flex items-center gap-3">
              <span className="inline-flex items-center justify-center w-10 h-10 rounded-2xl bg-[#F2EDE4] text-[#C9A84C]">
                <Music size={22} />
              </span>
              Background Audio
            </h1>
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#C9A84C] hover:bg-[#a65d14] disabled:opacity-60 text-white px-5 py-2.5 rounded-xl font-bold transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0"
          >
            {status === 'saving' ? (
              <>
      ...
      {hasUnsavedChanges && (
        <ScrollReveal delay={50}>
          <div className="mb-4 flex items-center gap-2 text-sm font-semibold text-gray-200 bg-gray-200 border border-gray-200 rounded-xl px-4 py-2.5 w-fit">
      ...
      <div className="space-y-6">
        ...
        <ScrollReveal delay={100}>
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 shadow-2xl border border-gray-700">
            ...
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-gray-200 rounded-full blur-2xl pointer-events-none" />

            <div className="relative p-6">
              {/* Header row */}
              <div className="flex items-center gap-3 mb-5">
                <div className="flex items-center justify-center w-10 h-10 rounded-2xl bg-[#C9A84C]/20 text-gray-200 ring-1 ring-[#C9A84C]/30">
                  <Volume2 size={20} />
                </div>
                <div>
              ...
              <div className="flex items-end gap-1 mb-5 h-8">
                {[3, 6, 4, 8, 5, 7, 3, 6, 5, 4, 7, 5, 3, 6].map((h, i) => (
                  <div
                    key={i}
                    className="w-1.5 rounded-full bg-[#C9A84C]/60"
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="flex bg-gray-100 rounded-2xl p-1 mb-6 w-fit gap-1">
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2 rounded-xl text-sm font-semibold transition-all ${
                  inputMode === 'url'
                    ? 'bg-white text-[#C9A84C] shadow-sm ring-1 ring-[#F2EDE4]'
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-[#C9A84C] focus:ring-2 focus:ring-[#F2EDE4] transition-all font-medium text-sm"
                  />
                  <button
                    onClick={handleUrlApply}
                    className="shrink-0 px-4 py-3 bg-[#F2EDE4]/50 hover:bg-[#F2EDE4] text-[#C9A84C] font-bold rounded-xl border border-gray-200 transition-all text-sm"
                  >
                    Preview
                  </button>
                </div>
            ...
            {inputMode === 'file' && (
              <div className="space-y-3">
                ...
                <div
                  className="relative flex flex-col items-center justify-center gap-3 w-full border-2 border-dashed border-gray-200 rounded-2xl p-8 bg-[#F2EDE4]/50/40 hover:bg-[#F2EDE4]/50 cursor-pointer transition-all group"
                  onClick={() => fileInputRef.current?.click()}
                >
                  <div className="w-14 h-14 rounded-2xl bg-[#F2EDE4] group-hover:bg-gray-200 flex items-center justify-center text-[#C9A84C] transition-all">
                    <Upload size={26} />
                  </div>
                  {fileName ? (
        ...
        <ScrollReveal delay={200}>
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">
              ...
              <code className="bg-gray-100 px-1.5 py-0.5 rounded-md text-xs font-mono text-[#2C2C2C]">
                /background.mp3
              </code>
              .
            </p>
        ...
        <ScrollReveal delay={250}>
          <div className="flex items-start gap-3 bg-gray-200 border border-gray-200 rounded-2xl px-5 py-4">
            <AlertTriangle size={20} className="text-gray-200 shrink-0 mt-0.5" />
